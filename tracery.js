...
var tracery = function() {
                ...
                for (let i = 0; i < this.modifiers.length; i++) {
                  ...
                  if (modName.indexOf("(") > 0) {
                    ...
                    if (!results || results.length < 2) {
                        ...
                        const escapedComma = '\\,';
                        const escapedCommaPlaceholder = "%%ESCAPED_COMMA%%";
    ...
    const utils = {
      replace: (str,oldSubtring,newSubstring) => str.replace(new RegExp(escapeRegExp(oldSubtring), 'g'), newSubstring)
    }
